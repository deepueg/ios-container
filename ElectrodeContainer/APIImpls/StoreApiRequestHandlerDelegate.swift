...
@objc public protocol StoreApiRequestHandlerDelegate
{
    func registerPlaceOrderRequestHandler()
    func registerGetOrderByIdRequestHandler()
    func registerDeleteOrderRequestHandler()
}
