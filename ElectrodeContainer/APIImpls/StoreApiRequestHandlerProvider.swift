 ...
 */
@objc public class StoreApiRequestHandlerProvider : RequestHandlerProvider, StoreApiRequestHandlerDelegate
{
    /**
     * - Parameter config : Optional config object that can be passed to an api impl provider.
     */
    init(handlerConfig: StoreApiConfig? = nil)
    {
        super.init(config: handlerConfig)
    }

    public func registerPlaceOrderRequestHandler()
    {
        // TODO: Needs to be implemented.
    }
    public func registerGetOrderByIdRequestHandler()
    {
        // TODO: Needs to be implemented.
    }
    public func registerDeleteOrderRequestHandler()
    {
        // TODO: Needs to be implemented.
    }
...
public class StoreApiConfig : RequestHandlerConfig
{
